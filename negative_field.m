function negative_field
    ...
    parentFolderPath = "C:\Thesis\Pre-processing-Ellipcity";
    % Parent folder to save the .mat files
    outputParentFolderPath = "C:\Thesis\Negative field-Ellipcity\Negative field result";

    % List of subfolders to process
    subFolders = {'BIRADS 2', 'BIRADS 3', 'BIRADS 4', 'BIRADS 5'};
